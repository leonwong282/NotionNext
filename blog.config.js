...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '04388db5eaaf456d94c1a5e4d347b410',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LiangWatcher', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'An ordinary dry rice man 🍚.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://liangwatcher.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, Blog, computer, AI, CS, EE, 博客, 计算机, 人工智能', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，I am a college student, sharing learning and thinking, welcome to my blog🎉',
